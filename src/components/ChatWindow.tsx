...
export default function ChatWindow({ 
  ...
  return (
    <div className="flex-1 flex flex-col bg-background">
      ...
      <div className="flex items-center justify-between p-4 border-b border-border bg-muted/30">
        <div className="flex items-center space-x-3">
          <Avatar className="h-10 w-10">
            <AvatarFallback className="text-white font-semibold text-sm" style={{ backgroundColor: '#128C7E' }}>
      ...
      {/* Messages Area */}
      <div className="flex-1 flex flex-col bg-whatsapp-background whatsapp-pattern">
        <ScrollArea className="flex-1 px-4 py-2" ref={scrollAreaRef}>
          {isLoading ? (
            ...
            <div className="space-y-1 py-4 min-h-full">
        ...
        <div className="p-4 border-t border-border bg-muted/30">
          <div className="flex items-end space-x-2">
            ...
            <Button 
              ...
              className="text-white h-11 w-11 rounded-full p-0 flex items-center justify-center hover:opacity-90"
